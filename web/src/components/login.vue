      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="register-div" v-show="MODAL_STATUS === STATUS_REGISTER">
            <h3>注&nbsp;&nbsp;册</h3>
            <div class="form-group">
              <label for="register-mobile"></label>
            ...
            <div class="form-group">
              <div class="input-group">
                <label for="register-mobile-code"></label>
          ...
          <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
            ...
            <div class="form-group">
              <label for="forget-confirm-password"></label>
