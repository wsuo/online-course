...
public class VodUtil {
     ...
     * @throws Exception
     */
    private static GetMezzanineInfoResponse getMezzanineInfo(DefaultAcsClient client, String videoId) throws Exception {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            /*
            7d6b8c07ab48456e932187080f42e88f
             */
